...
public final class AjaxLoginConfigurer<H extends HttpSecurityBuilder<H>> extends
    ...
    public void configure(H http) throws Exception {
        ...
        getAuthenticationFilter().setAuthenticationSuccessHandler(ajaxAuthenticationSuccessHandler);
        getAuthenticationFilter().setAuthenticationFailureHandler(ajaxAuthenticationFailureHandler);
    ...
    public AjaxLoginConfigurer<H> successHandlerAjax(AuthenticationSuccessHandler successHandler) {
        this.ajaxAuthenticationSuccessHandler = successHandler;
        return this;
    }

    public AjaxLoginConfigurer<H> failureHandlerAjax(AuthenticationFailureHandler failureHandler) {
        this.ajaxAuthenticationFailureHandler = failureHandler;
        return this;
    }
